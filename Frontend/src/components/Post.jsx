                    ...
                    >
                        <Card className="shadow m-5" key={key}>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>{new Date(posteo.createdAt).getDate()} / {new Date(posteo.createdAt).getMonth() + 1} / {new Date(posteo.createdAt).getFullYear()}</Card.Text>
                            </Card.Body>
                        </Card>
                    </div>
                )) :
                    <div style={backgroundImage} className='d-flex justify-content-center align-items-center vh-100'>
                        <h2>Se el primero en postear, registrate o inicia sesión para hacerlo!</h2>
                    </div>
            }
        </>
    )
